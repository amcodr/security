...
//        adding new settings here to solve the error " java.lang.IllegalArgumentException: unknown setting [opendistro_security.system_indices.enabled] did you mean any of "

        settings.add(Setting.boolSetting("opendistro_security.system_indices.enabled",false,Property.NodeScope));
        settings.add(Setting.boolSetting("opendistro_security.dynamic.http.anonymous_auth_enabled",false,Property.NodeScope));
        settings.add(Setting.boolSetting("opendistro_security.dynamic.http.xff.enabled",false,Property.NodeScope));
        settings.add(Setting.boolSetting("opendistro_security.dynamic.authc.basic_internal_auth_domain.http_enabled",true,Property.NodeScope));
